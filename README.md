...
AI was used for modifying application layouts in Qt and doing code reviews, and implementing tests. Code reviews can be viewed here: https://github.com/pquam/Quamium/commits/main/codereview.md
